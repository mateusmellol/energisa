  ...
  "inline-flex items-center text-tremor-label font-semibold",
  {
    variants: {
      variant: {
        ...
        complex:
          "gap-2.5 rounded-tremor-default bg-tremor-background py-1 pl-2.5 pr-1 ring-1 ring-inset ring-gray-200 dark:bg-dark-tremor-background dark:ring-gray-800",
      },
      deltaType: {
        increase: "",
        decrease: "",
